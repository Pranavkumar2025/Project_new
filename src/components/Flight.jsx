...
const Flight = () => {
  return (
    <div className="bg-[#0F0B0C] min-h-screen flex justify-center items-center p-6">
      <div className="flex flex-col sm:flex-row gap-6 max-w-5xl w-full">
        {data.map((item) => (
          <div
            key={item.id}
            className="flex flex-col rounded-2xl overflow-hidden border border-transparent transition-all duration-500 ease-in-out hover:shadow-2xl group cursor-pointer w-full sm:w-1/2 min-h-[420px]"
          >
            <div className="bg-[#1D0E11] flex flex-col flex-grow p-4">
              ...
              <div className="p-6 text-white flex-grow flex flex-col justify-between">
                <div>
